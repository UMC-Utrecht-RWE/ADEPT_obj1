...
- **For Objective 1.5:**
    Note for EHR Databases: If participating in Objective 1.5, please ensure you have your PRODUCTS table in the CDM directory. Values in *subst1_amount_per_form* column
     must be in mgs! 
---
