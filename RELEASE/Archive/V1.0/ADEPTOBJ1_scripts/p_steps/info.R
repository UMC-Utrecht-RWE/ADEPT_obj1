...
actual_tables <- list(
  MEDICINES            = get_files(CDM_dir, "^MEDICINES"),
  EVENTS               = get_files(CDM_dir, "^EVENTS"),
  PROCEDURES           = get_files(CDM_dir, "^PROCEDURES"),
  MEDICAL_OBSERVATIONS = get_files(CDM_dir, "^MEDICAL_OBSERVATIONS"),
  SURVEY_ID            = get_files(CDM_dir, "^SURVEY_ID"),
  SURVEY_OBSERVATIONS  = get_files(CDM_dir, "^SURVEY_OBSERVATIONS"),
  EUROCAT              = get_files(CDM_dir, "^EUROCAT"),
  VACCINES             = get_files(CDM_dir, "^VACCINES")
)
