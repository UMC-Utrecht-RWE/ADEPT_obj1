###########################################################################################################################
# EFEMERIS has a pregnancy only cohort and uses pregnancy file created by the pregnancy algorithm as the study population #
###########################################################################################################################
...
study_population[,op_start_date := as.IDate(pregnancy_start_date) - lookback_period]
study_population[,op_start_date :=as.IDate(op_start_date)][,op_end_date   := as.IDate(pregnancy_end_date)]
