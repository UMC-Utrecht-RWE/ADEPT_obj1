...
for(i in 1:nrow(SCHEME_04)){
  ...
  saveRDS(FlowChartSourcetoStudy,file = paste0(path_study_source_pop, gsub("study_population.rds","",SCHEME_04[["file_out"]][i]),"FlowChartSourcetoStudy.rds"))
...
saveRDS(FlowChart3,file = paste0(path_study_source_pop,"FlowChart3.rds"))
saveRDS(SCHEME_04,file = paste0(path_study_source_pop,"SCHEME_04.rds"))
