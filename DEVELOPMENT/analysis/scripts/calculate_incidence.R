...
# TODO Incidence not being properly calculated in episodes with multiple ATC
...
for (epi in seq_along(tx_episode_files)) {
  ...
  # Save results 
  saveRDS(incidence_all, file.path(paths$D4_dir, "1.1_incidence", paste0(file_name, "_incidence.rds")))
}