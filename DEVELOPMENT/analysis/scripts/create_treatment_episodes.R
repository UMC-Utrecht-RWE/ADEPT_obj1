...
list_exposures <- list_exposures[grepl(paste0("^", pop_prefix, "_"), list_exposures)]
list_exposures <- list_exposures <- list_exposures[grepl(paste0("^", pop_prefix, "_"), list_exposures) &(pop_prefix != "PC" | !grepl("^PC_HOSP_", list_exposures))]
