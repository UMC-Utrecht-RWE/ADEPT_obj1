...
# If study population file has no rows, then the script stops
if (nrow(study_population) == 0) stop("No study population found. Scripts aborted: denominator cannot be created.")
